...
# sentence_classification documentation build
...
from sentence_classification import __version__ as release

# -- Project information -----------------------------------------------------

project = "sentence_classification"
author = "Kedro"
...
htmlhelp_basename = "sentence_classificationdoc"
...
latex_documents = [
    (
        master_doc,
        "sentence_classification.tex",
        "sentence_classification Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "sentence_classification",
        "Project sentence_classification codebase.",
        "Nearest-Neighbour",
    )
]
